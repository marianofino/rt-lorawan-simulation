      ...
      "data": [
        {
          ...
          "transform": [
            ...
            {"type": "formula", "as": "text_value", "expr": `datum.id` }
          ]
        },
...
function getGatewaysPlacement(qty, distanceBtwCenters, iteration) {
  ...
  for (const i in gateways) {
    ...
    gateways[i].id = parseInt(i) + 1
    
    const offset = 5 // in percentage
    distanceBtwCenters *= 1-offset/100
