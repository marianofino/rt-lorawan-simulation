...
static TypeId tid = TypeId ("ns3::ClassAEndDeviceLorawanMac")
  ...
  .AddTraceSource ("FinishSendingPacket",
                   "Trace source indicating a new packet has been sent",
                   MakeTraceSourceAccessor (&ClassAEndDeviceLorawanMac::m_packetFinish),
